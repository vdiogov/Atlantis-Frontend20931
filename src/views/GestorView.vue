...
export default {
  ...
  methods: {
    ...
    async addNormal() {
      ...
      this.axios.post("https://atlantis-backend20931.herokuapp.com/queue/", json,
        {
          headers: {
    ...
    async addSpecial() {
      ...
      this.axios.post("https://atlantis-backend20931.herokuapp.com/queuespecial/", json,
        {
          headers: {
            Authorization: 'Bearer ' + this.jwt,
            'Content-Type': 'application/json',
    ...
    async delALL() {
      if (confirm("Deseja realmente limpar as senhas preferenciais chamadas?")) {
        ...
        if (typeof this.senhas[0] != "undefined") {
          ...
          this.axios.delete('https://atlantis-backend20931.herokuapp.com/queueDELETE/',
            {
              headers: {
                Authorization: 'Bearer ' + this.jwt,
                'Content-Type': 'application/json',
    ...
    async delALLSpecial() {
      if (confirm("Deseja realmente limpar as senhas preferenciais chamadas?")) {
        ...
        if (typeof this.senhas2[0] != "undefined") {
          ...
          this.axios.delete('https://atlantis-backend20931.herokuapp.com/queuespecialDELETE/',
            {
              headers: {
                Authorization: 'Bearer ' + this.jwt,
                'Content-Type': 'application/json',
    ...
    getNormal() {
      this.axios.get("https://atlantis-backend20931.herokuapp.com/queue/").then(
        (response) => {
          var list = [];
    ...
    getSpecial() {
      this.axios.get("https://atlantis-backend20931.herokuapp.com/queuespecial/").then(
        (response) => {
          var list = [];
          for (var i = 0; i < response.data.results.length; i++) {
            var item = {};
    ...
    async getLogin() {
      ...
      this.axios.get("https://atlantis-backend20931.herokuapp.com/users/?username=" + this.user,{
              headers: {
                Authorization: 'Bearer ' + this.jwt,
                'Content-Type': 'application/json',
              }
