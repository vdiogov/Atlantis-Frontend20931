...
const store = createStore({
    state: {
        ...
        endpoints: {
            obtainJWT: 'https://atlantis-backend20931.herokuapp.com/api/token/',
            refreshJWT: 'https://atlantis-backend20931.herokuapp.com/api/token/refresh/',
            verifyJWT: 'https://atlantis-backend20931.herokuapp.com/api/token/verify/',
        }
    },
    mutations: {
